      ...
      <div>
        ...
        <p className="text-slate-400 text-base leading-relaxed mb-8">
          ...
          <strong className="text-slate-300">
            200+ KOL pitches in your inbox.
          </strong>{" "}
          No deliverables, no accountability — just{" "}
          <em>"2 tweets for $100."</em>
          <br />
          <br />
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <a
            href="#cta"
            className="border border-slate-700 text-slate-400 px-7 py-3 rounded-lg text-sm font-medium"
          >
            Book a Demo →
          </a>
        </div>
      ...
      <div>
        <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden">
          <div className="bg-slate-800 px-5 py-3 flex items-center gap-3 border-b border-slate-900">
            <div className="w-8 h-8 rounded-full bg-linear-to-br from-blue-500 to-violet-700 flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
              K
            </div>
            <div>
          ...
          <div className="px-5 py-5 flex flex-col gap-3">
            <ChatMsg
              from="them"
              text="I will do 2 tweets for $500. Last offer!"
            />
          ...
          <div className="bg-slate-800 border-t border-slate-900 px-5 py-3 flex items-center gap-2">
            <span className="bg-violet-700 text-white text-xs font-bold px-2.5 py-0.5 rounded-full">
              200+
            </span>
        ...
        <div className="mt-3 bg-linear-to-r from-blue-500/10 to-purple-500/10 border border-slate-700 rounded-xl p-4 flex items-start gap-3">
          <span className="text-xl shrink-0">⛓</span>
          <p className="text-sm text-slate-400 leading-relaxed">
            <strong className="text-emerald-300">Segmento changes this.</strong>{" "}
